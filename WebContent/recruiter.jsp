...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="assets/img/favicon.ico">
            ...
            <link rel="stylesheet" type="text/css" href="assets/css/search.css"></head>
                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="#" target="" class="btn btn-simple btn-white btn-just-icon">
                                        ...
                                        <div class="card card-signup">
                                            <form class="form" method="get" action="Servlet_search">
                                                <div class="header header-primary text-center">
                                                    <h3>Welcome <%=name %></h3>
                                                    <h4>Wish to hire a developer?
                                                        <br>Search below.</h4>
                                                        <div class="social-line">
                                                            <i class="btn btn-simple btn-just-icon fa fa-search"></i>
                                                            <i class="btn btn-simple btn-just-icon fa fa-slack"></i>
                                                            <i class="btn btn-simple btn-just-icon fa fa-users"></i>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="skill" class="form-control" id="skill" placeholder="Search for Skill..."></div>
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="cradio" value="1">
                                                                            Yes
                                                                        </label>
                                                                        <label>
                                                                            <input type="radio" name="cradio" value="0" checked>
                                                                                No
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="rradio" value="1">
                                                                                    Yes
                                                                                </label>
                                                                                <label>
                                                                                    <input type="radio" name="rradio" value="0" checked>
                                                                                        No
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="input-group">
                                                                                ...
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input type="radio" name="iradio" value="1">
                                                                                            Yes
                                                                                        </label>
                                                                                        <label>
                                                                                            <input type="radio" name="iradio" value="0" checked>
                                                                                                No
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <div class="radio">
                                                                                            <label>
                                                                                                <input type="radio" name="pradio" value="1">
                                                                                                    Yes
                                                                                                </label>
                                                                                                <label>
                                                                                                    <input type="radio" name="pradio" value="0" checked>
                                                                                                        No
                                                                                                    </label>
                                                                                                </div>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="footer text-center">
                                                                                            <button type="submit" class="btn btn-primary btn-simple btn-lg btn-login-submit">Search</button>
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <section class="search-result-item">
                                                                                        <a class="image-link" href='<%=redirect %>'>
                                                                                            <img class="image" src="assets/img/avatar.jpg"></a>
                                                                                                            	...
                                                                                                            	<%=fieldOfInterest %><br>
                                                                                                          		...
                                                                                                          		<%=nationality %>
                                                                                                                    ...
                                                                                                                    <div class="col-sm-3 text-align-center">
                                                                                                                        <a class="btn btn-primary btn-sm" href='<%=redirect %>'>Learn More</a>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </section>
